    ...
    <div>
      ...
      <div class="grid grid-cols-3 gap-4 mb-6">
        <div class="bg-cardbg rounded-lg p-4 relative overflow-hidden">
          <div class="text-5xl font-bold text-yellow-500 mb-2">{summary.total}</div>
        ...
        <div class="bg-cardbg rounded-lg p-4 relative overflow-hidden">
          <div class="text-5xl font-bold text-red-500 mb-2">{summary.pending}</div>
        ...
        <div class="bg-cardbg rounded-lg p-4 relative overflow-hidden">
          <div class="text-5xl font-bold text-green-500 mb-2">{summary.delivered}</div>
